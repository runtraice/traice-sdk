...
const testEvents: CostEvent[] = [
  makeEvent({ id: "e1", feature: "chat", userId: "user_a", totalCostUSD: 0.1, totalTokens: 1000 }),
...
describe("summarize", () => {
  it("groups by feature and sorts by cost desc", () => {
    ...
    expect(rows[0].totalCost).toBeCloseTo(0.3, 4);
  ...
  it("calculates avgCostPerCall", () => {
    ...
    expect(chat.avgCostPerCall).toBeCloseTo(0.1, 4);
  });
