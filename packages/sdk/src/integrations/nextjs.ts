 ...
 * @example
 * ```typescript
 * import { withCostTracking } from '@traice/sdk/nextjs';
 *
 ...
 * @example
 * ```typescript
 * import { withMeteredAction } from '@traice/sdk/nextjs';
 *
 ...
 * @example
 * ```typescript
 * import { createNextApiHandler } from '@traice/sdk/nextjs';
 *
 ...
 * ```
 */
export function createNextApiHandler(config: NextCostTrackingConfig, handler: (req: any, res: any) => Promise<void>) {
