...
async function main() {
  const DEMO_FILE = "./.traice-costs/demo-events.ndjson";
  ...
  console.log("━━━ Step 1: Configure @traice/sdk ━━━");
  console.log("");
  ...
  console.log("");
  console.log("$ npx @traice/sdk report --file " + DEMO_FILE);
  console.log("");
  ...
  // By user
  console.log("$ npx @traice/sdk report --group-by userId --file " + DEMO_FILE);
  console.log("");

  try {
    const output = execSync(`node dist/cli.js report --group-by userId --file ${DEMO_FILE}`, { encoding: "utf-8" });
    console.log(output);
  } catch (e: any) {
    console.log(e.stdout || e.message);
  }
  ...
  // By model
  console.log("$ npx @traice/sdk report --group-by model --file " + DEMO_FILE);
  console.log("");

  try {
    const output = execSync(`node dist/cli.js report --group-by model --file ${DEMO_FILE}`, { encoding: "utf-8" });
    console.log(output);
  } catch (e: any) {
    console.log(e.stdout || e.message);
  }
  ...
  // JSON export
  console.log("$ npx @traice/sdk report --format json --top 2 --file " + DEMO_FILE);
  console.log("");

  try {
    const output = execSync(`node dist/cli.js report --format json --top 2 --file ${DEMO_FILE}`, { encoding: "utf-8" });
    console.log(output);
  } catch (e: any) {
    console.log(e.stdout || e.message);
  }
  ...
  // CSV export
  console.log("$ npx @traice/sdk report --format csv --file " + DEMO_FILE);
  console.log("");

  try {
    const output = execSync(`node dist/cli.js report --format csv --file ${DEMO_FILE}`, { encoding: "utf-8" });
    console.log(output);
  } catch (e: any) {
    console.log(e.stdout || e.message);
  }
  ...
  console.log("║    npx @traice/sdk report --file " + DEMO_FILE.padEnd(20) + "║");
  console.log("║    npx @traice/sdk report --group-by userId          ║");
  console.log("║    npx @traice/sdk report --format csv > costs.csv   ║");
  console.log("╚══════════════════════════════════════════════════════════╝");
  console.log("");
}
