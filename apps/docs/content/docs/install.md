...
Setup starts browser authorization when needed, stores the renewable session in the operating system credential
...
[Collector Overview](/docs/collector-overview#cli-reference) for optional identity, subscription, backfill, server,
